...
import { IconUser, IconChevronDown, IconHome, IconLogout, IconSun, IconMoon } from "@tabler/icons-react";
          ...
          <BreadcrumbList>
            ...
            <BreadcrumbItem>
              <BreadcrumbPage className="font-medium truncate">
                <span className="hidden sm:inline">Movie Dashboard</span>
